...
function applyInitialSystemTheme() {
    const nativeTheme = window.__WHERE_MONEY_SYSTEM_DARK__;
    const isDark = typeof nativeTheme === "boolean"
        ? nativeTheme
        : window.localStorage.getItem("__WHERE_MONEY_SYSTEM_DARK__") === "true";
